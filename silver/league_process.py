...
def silver_step_league():
    ...
    path = '/home/fececa/airflow/dags/fifa/data/bronze/league/'
    ...
    df = df.withColumn("file_date", col("file_date").cast(DateType())) \
                    ...
                    .withColumn("nationId", col("nationId").cast(LongType()))

    df = df.fillna({'id': 0, 'nationId': 0})
    ...
    output_path = '/home/fececa/airflow/dags/fifa/data/silver/league/'
